...
Production / staging tables were created and evolved under Prisma until the Drizzle cutover.

As of PR3:

- **Schema owner:** Drizzle Kit (`packages/db/drizzle`)
- **Runtime:** `@marble/db` (CMS neon-serverless; API/jobs Hyperdrive `pg`)
