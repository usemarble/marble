...
export const YouTubeUploadView = ({ getPos, editor, node }: NodeViewProps) => {
  const onSubmit = useCallback(
    (url: string) => {
      ...
      // landing wherever the caret happens to be, then let `setYoutubeVideo`
      // run its own validation over the URL.
      editor
        .chain()
        .focus()
