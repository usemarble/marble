...
export const workspace = pgTable("workspace", {
	...
	uniqueIndex("workspace_subdomain_key").using("btree", table.subdomain.asc().nullsLast().op("text_ops")),
]);
...
export const session = pgTable("session", {
	...
	index("session_activeOrganizationId_idx").using("btree", table.activeOrganizationId.asc().nullsLast().op("text_ops")),
...
export const member = pgTable("member", {
	...
	index("member_organizationId_userId_idx").using("btree", table.organizationId.asc().nullsLast().op("text_ops"), table.userId.asc().nullsLast().op("text_ops")),
...
export const invitation = pgTable("invitation", {
	...
	index("invitation_inviterId_idx").using("btree", table.inviterId.asc().nullsLast().op("text_ops")),
...
export const workspaceNotificationPreferences = pgTable("workspace_notification_preferences", {
	...
	uniqueIndex("workspace_notification_preferences_memberId_key").using("btree", table.memberId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const subscription = pgTable("subscription", {
	...
	createdAt: timestamp("createdAt", { precision: 3, mode: "date" }).$defaultFn(() => new Date()).notNull(),
	currentPeriodEnd: timestamp("currentPeriodEnd", { precision: 3, mode: "date" }).notNull(),
	currentPeriodStart: timestamp("currentPeriodStart", { precision: 3, mode: "date" }).notNull(),
	...
	recurringInterval: subscriptionRecurringIntervalEnum().default('month').notNull(),
...
export const author = pgTable("author", {
	...
	index("author_userId_idx").using("btree", table.userId.asc().nullsLast().op("text_ops")),
	index("author_workspaceId_isActive_idx").using("btree", table.workspaceId.asc().nullsLast().op("text_ops"), table.isActive.asc().nullsLast().op("bool_ops")),
	uniqueIndex("author_workspaceId_slug_key").using("btree", table.workspaceId.asc().nullsLast().op("text_ops"), table.slug.asc().nullsLast().op("text_ops")),
	uniqueIndex("author_workspaceId_userId_key").using("btree", table.workspaceId.asc().nullsLast().op("text_ops"), table.userId.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.workspaceId],
			foreignColumns: [workspace.id],
...
export const authorSocial = pgTable("author_social", {
	id: text("id").primaryKey().$defaultFn(createId).notNull(),
	...
	index("author_social_authorId_idx").using("btree", table.authorId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const category = pgTable("category", {
	...
	index("category_workspaceId_idx").using("btree", table.workspaceId.asc().nullsLast().op("text_ops")),
	uniqueIndex("category_workspaceId_slug_key").using("btree", table.workspaceId.asc().nullsLast().op("text_ops"), table.slug.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.workspaceId],
			foreignColumns: [workspace.id],
...
export const tag = pgTable("tag", {
	...
	index("tag_workspaceId_idx").using("btree", table.workspaceId.asc().nullsLast().op("text_ops")),
	uniqueIndex("tag_workspaceId_slug_key").using("btree", table.workspaceId.asc().nullsLast().op("text_ops"), table.slug.asc().nullsLast().op("text_ops")),
	foreignKey({
			columns: [table.workspaceId],
			foreignColumns: [workspace.id],
...
export const post = pgTable("post", {
	...
	updatedAt: timestamp("updatedAt", { precision: 3, mode: "date" }).$defaultFn(() => new Date()).$onUpdateFn(() => new Date()).notNull(),
	createdAt: timestamp("createdAt", { precision: 3, mode: "date" }).$defaultFn(() => new Date()).notNull(),
	publishedAt: timestamp("publishedAt", { precision: 3, mode: "date" }).notNull(),
...
export const postToAuthor = pgTable("_PostToAuthor", {
	a: text("A").notNull(),
	b: text("B").notNull(),
}, (table) => [
	index().using("btree", table.b.asc().nullsLast().op("text_ops")),
...
export const shareLink = pgTable("ShareLink", {
	...
	index("ShareLink_expiresAt_idx").using("btree", table.expiresAt.asc().nullsLast().op("timestamp_ops")),
	index("ShareLink_isActive_idx").using("btree", table.isActive.asc().nullsLast().op("bool_ops")),
	index("ShareLink_postId_idx").using("btree", table.postId.asc().nullsLast().op("text_ops")),
	uniqueIndex("ShareLink_token_key").using("btree", table.token.asc().nullsLast().op("text_ops")),
	index("ShareLink_workspaceId_idx").using("btree", table.workspaceId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const fieldValue = pgTable("field_value", {
	...
	index("field_value_fieldId_idx").using("btree", table.fieldId.asc().nullsLast().op("text_ops")),
	uniqueIndex("field_value_postId_fieldId_key").using("btree", table.postId.asc().nullsLast().op("text_ops"), table.fieldId.asc().nullsLast().op("text_ops")),
	index("field_value_postId_idx").using("btree", table.postId.asc().nullsLast().op("text_ops")),
	index("field_value_workspaceId_idx").using("btree", table.workspaceId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const webhookDelivery = pgTable("webhook_delivery", {
	...
	index("webhook_delivery_eventId_idx").using("btree", table.eventId.asc().nullsLast().op("text_ops")),
...
export const usageAlert = pgTable("usage_alert", {
	id: text("id").primaryKey().$defaultFn(createId).notNull(),
	workspaceId: text("workspaceId").notNull(),
	type: usageEventTypeEnum().notNull(),
	kind: usageAlertKindEnum().notNull(),
	periodStart: timestamp("periodStart", { precision: 3, mode: "date" }).notNull(),
