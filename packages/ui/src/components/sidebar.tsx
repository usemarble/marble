...
type SidebarGroupLabelProps = React.ComponentProps<"div"> & useRender.ComponentProps<"div">

function SidebarGroupLabel(props: SidebarGroupLabelProps) {
  const { className, render = <div />, ...rest } = props
...
type SidebarGroupActionProps = React.ComponentProps<"button"> & useRender.ComponentProps<"button">

function SidebarGroupAction(props: SidebarGroupActionProps) {
  const { className, render = <button />, ...rest } = props
...
function SidebarMenuButton(props: SidebarMenuButtonProps) {
  ...
  const button = useRender({
    render,
    props: mergeProps<"button">(defaultProps, { ...rest, children }),
  })
...
function SidebarMenuAction(props: SidebarMenuActionProps) {
  const { className, render = <button />, showOnHover = false, ...rest } = props
...
function SidebarMenuSubButton(props: SidebarMenuSubButtonProps) {
  const { size = "md", isActive = false, className, render = <a />, ...rest } = props
