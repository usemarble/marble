    ...
    return (
      <Tabs defaultValue="upload" className="w-full">
        ...
        <TabsContent value="media">
          <ScrollArea className="w-whitespace-nowrap border">
  ...
  return (
    <div className="">
      ...
      >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-muted-foreground text-xs max-w-64">
                          A featured image usually used for the post thumbnail
                          and social media previews (optional)
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-muted-foreground text-xs max-w-64">
                          The date your post was published. This is set by
                          default but you can change it to any date.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
        ...
        <SidebarFooter className="bg-sidebar px-6">
          <Button
            type="button"
