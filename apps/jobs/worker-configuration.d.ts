/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: 008b9da175965a52accc63a43cdc23a4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "REDIS_URL" | "REDIS_TOKEN" | "ENVIRONMENT" | "RESEND_API_KEY">> {}
}
