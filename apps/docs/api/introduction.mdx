---
title: "REST API basics: URL, auth, and responses"
sidebarTitle: "Introduction"
description: "Overview of the Marble REST API: base URL, API key authentication, scope-based permissions, JSON response format, and HTTP error codes."
---
