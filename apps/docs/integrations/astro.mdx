...
sidebarTitle: "Astro"
description: "Integrate Marble with Astro using Content Collections and a custom SDK-powered Content Loader, with typed list pages and dynamic slug routes."
---
