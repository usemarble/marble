---
title: "Marble Content Model and Post Schema"
description: "Marble's content model — how posts relate to authors, a single category, multiple tags, and custom fields, with the fields and JSON shape returned by the API."
---
