---
title: "Syntax Highlighting for Marble Posts"
description: "Add Shiki-powered syntax highlighting to code blocks in Marble posts, with a reusable highlighter, dual light and dark themes, and SDK integration."
---
