---
title: "Custom Fields for Marble Posts"
description: Extend Marble posts with structured workspace-specific metadata like release dates, priorities, or product names and read them from the API.
---
