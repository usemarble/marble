...
sidebarTitle: "Media"
description: "Upload images, video, audio, and documents to Marble's built-in media library and CDN, then embed them in posts or access them via the REST API and MCP."
---
