/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.example --env-interface=CloudflareBindings` (hash: 36d9492e499e87a7b907059bdaf633e3)
// Runtime types generated with workerd@1.20260811.1 2026-05-02 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "REDIS_URL" | "REDIS_TOKEN" | "POLAR_ACCESS_TOKEN" | "ENVIRONMENT" | "SYSTEM_SECRET" | "RESEND_API_KEY">> {}
}
